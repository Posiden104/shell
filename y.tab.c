...
{
       0,    39,    39,    43,    44,    47,    51,    55,    58,    67,
      74,    75,    79,    88,    94,   100,   106,   107,   111,   112,
     116,   120,   124,   130,   135,   146,   150
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE", "LESS", "DGREAT", "DLESS", "AMP", "GREATAMP", "DGREATAMP",
  "EXIT", "SUBSHELL", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "argument_list", "argument",
  "command_word", "pipe_args", "iomodifier_list", "iomodifier_opt",
  "bg_opt", YY_NULLPTR
};
#endif
...
{
       1,     3,    -1,    -1,    -1,    10,     0,    -1,    -1,    -1,
      -1,     4,    -1,    -1,    -1,     2,     5,    13,    -1,    -1,
      -1,    -1,     9,    17,    20,    -1,    24,    25,    -1,     7,
      -1,    -1,    -1,    -1,    -1,    -1
};
...
{
       0,     0,    14,     7,    15,     0,     0,     3,     5,    17,
      11,    19,     8,     1,     4,     9,     0,    26,    12,    13,
...
{
      -2,     1,     1,     2,     2,    18,     3,     3,     2,    12,
      13,    16,    30,    35,     4,     4,     0,    19,    22,     4,
      31,    23,    24,    32,    25,    26,    27,    33,    34,    14,
      21
};
...
{
       0,     1,     1,     3,     3,     3,     6,     6,     3,     6,
       0,     7,     3,     6,    14,    14,    -1,    15,     5,    14,
       3,     8,     9,     3,    11,    12,    13,     3,     3,     6,
      16
};
...
{
       0,     1,     3,     6,    14,    17,    18,    19,    20,    21,
      24,    25,     6,     0,    19,    22,     7,    26,     3,    15,
      23,    21,     5,     8,     9,    11,    12,    13,    27,    28,
       3,     3,     3,     3,     3,     6
};
...
#line 79 "shell.y" /* yacc.c:1646  */
    {
			...
			if(strchr((yyvsp[0].string_val), '*') == NULL && strchr((yyvsp[0].string_val), '?') == NULL) {
				...
				Command::_currentSimpleCommand->expandWildcardsIfNessessary(NULL,(yyvsp[0].string_val));
			}
	}
